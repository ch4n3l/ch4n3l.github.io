...
Essentially the `s` means that this executable has a sticky bit. Which means that whenever this executable is run, it will be run as the owner of the executable. Which in this case is root.
